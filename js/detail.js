...
<section class="detail-section bibliography-section">
    ...
    <p class="bibliography-legend">
        （○は縄張図など、△は記述のみ、Lは巻末リストなどのみ、―は未記載を表す。それ以外は註を参照）
    </p>
...
<section class="detail-note">
    ...
    <div class="note-item">
        <h4>「縄張り図」などについて：</h4>
        <p>
            「○」は縄張図のような構造図、「実測」は実測図または測量図、
            「現状」は現状図や地籍図、「復元」は復元図または推定図、
            「鳥瞰」は鳥瞰図を示す（分類は本会の見解による）。
            また「：」以下は作成者を示す。
        </p>
    </div>
    ...
    <div class="note-item">
        <h4>書籍について：</h4>
        <p>
            『日本城郭大系 10』は新人物往来社（1980）、
            『定本 和歌山県の城』は郷土出版社（1995）、
            『和歌山県中世城館跡詳細分布調査報告書』は和歌山県教委（1998）、
            『近畿の城郭Ⅰ〜Ⅴ』（2014〜18）及び『戦国和歌山の群雄と城館』は戎光祥出版（2019）の書籍。
            『和歌山城郭研究』1〜25（2002〜2026）は本会発行の研究誌で（）内は頁番号。
            ただし『和歌山県中世城館跡詳細分布調査報告書』については考察を記載した城のみ「△」、残りは「L」とした。
        </p>
    </div>
    ...
    <div class="note-item">
        <h4>その他の図について：</h4>
        <p>
            書籍以外では、著名なWebサイト”城郭放浪記”
            （https://www.hb.pei.jp/shiro/）の縄張り図情報を掲載した
            （2025/1/10 時点のもの）。
        </p>
    </div>
    ...
    <div class="note-item">
        <h4>関連資料について：</h4>
        <p>
            書名の記載が無いものは『和歌山城郭研究』の掲載で、
            数字は巻（頁）を示す。
            奈文研DOI は、奈良文化財研究所の全国文化財総覧の doi で、
            この数字を https://sitereports.nabunken.go.jp/ の後に付けるなどして利用する。
        </p>
    </div>
